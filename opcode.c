...
static INSTR_FUNC gen_opcode_table[256][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*CE*/   GENx___x___x___ ,
 /*CF*/   GENx___x___x___ ,
 /*D0*/   GENx___x390x900 ( "TRTR"      , SS_a , ASMFMT_SS_L     , translate_and_test_reverse                          ),
...
static INSTR_FUNC gen_opcode_b3xx[256][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*B32E*/ GENx___x390x900 ( "MAER"      , RRD  , ASMFMT_RRF_R    , multiply_add_float_short_reg                        ),
 /*B32F*/ GENx___x390x900 ( "MSER"      , RRD  , ASMFMT_RRF_R    , multiply_subtract_float_short_reg                   ),
 ...
 /*B338*/ GENx___x___x900 ( "MAYLR"     , RRD  , ASMFMT_RRF_R    , multiply_add_unnormal_float_long_to_ext_low_reg     ),
 /*B339*/ GENx___x___x900 ( "MYLR"      , RRD  , ASMFMT_RRF_R    , multiply_unnormal_float_long_to_ext_low_reg         ),
 /*B33A*/ GENx___x___x900 ( "MAYR"      , RRD  , ASMFMT_RRF_R    , multiply_add_unnormal_float_long_to_ext_reg         ),
 /*B33B*/ GENx___x___x900 ( "MYR"       , RRD  , ASMFMT_RRF_R    , multiply_unnormal_float_long_to_ext_reg             ),
 /*B33C*/ GENx___x___x900 ( "MAYHR"     , RRD  , ASMFMT_RRF_R    , multiply_add_unnormal_float_long_to_ext_high_reg    ),
 /*B33D*/ GENx___x___x900 ( "MYHR"      , RRD  , ASMFMT_RRF_R    , multiply_unnormal_float_long_to_ext_high_reg        ),
 /*B33E*/ GENx___x390x900 ( "MADR"      , RRD  , ASMFMT_RRF_R    , multiply_add_float_long_reg                         ),
 /*B33F*/ GENx___x390x900 ( "MSDR"      , RRD  , ASMFMT_RRF_R    , multiply_subtract_float_long_reg                    ),
...
static INSTR_FUNC gen_opcode_b9xx[256][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*B926*/ GENx___x390x900 ( "LBR"       , RRE  , ASMFMT_RRE      , load_byte_register                                  ),
 /*B927*/ GENx___x390x900 ( "LHR"       , RRE  , ASMFMT_RRE      , load_halfword_register                              ),
 ...
 /*B972*/ GENx___x390x900 ( "CRT"       , RRF_c, ASMFMT_RRF_M3   , compare_and_trap_register                           ),
 /*B973*/ GENx___x390x900 ( "CLRT"      , RRF_c, ASMFMT_RRF_M3   , compare_logical_and_trap_register                   ),
 ...
 /*B98D*/ GENx___x390x900 ( "EPSW"      , RRE  , ASMFMT_RRE      , extract_psw                                         ),
 /*B98E*/ GENx___x___x900 ( "IDTE"      , RRF_b, ASMFMT_RRF_R    , invalidate_dat_table_entry                          ),
 /*B98F*/ GENx___x___x___ ,
 /*B990*/ GENx___x390x900 ( "TRTT"      , RRF_c, ASMFMT_RRF_M3   , translate_two_to_two                                ),
 /*B991*/ GENx___x390x900 ( "TRTO"      , RRF_c, ASMFMT_RRF_M3   , translate_two_to_one                                ),
 /*B992*/ GENx___x390x900 ( "TROT"      , RRF_c, ASMFMT_RRF_M3   , translate_one_to_two                                ),
 /*B993*/ GENx___x390x900 ( "TROO"      , RRF_c, ASMFMT_RRF_M3   , translate_one_to_one                                ),
 /*B994*/ GENx___x390x900 ( "LLCR"      , RRE  , ASMFMT_RRE      , load_logical_character_register                     ),
 /*B995*/ GENx___x390x900 ( "LLHR"      , RRE  , ASMFMT_RRE      , load_logical_halfword_register                      ),
 /*B996*/ GENx___x390x900 ( "MLR"       , RRE  , ASMFMT_RRE      , multiply_logical_register                           ),
 /*B997*/ GENx___x390x900 ( "DLR"       , RRE  , ASMFMT_RRE      , divide_logical_register                             ),
 /*B998*/ GENx___x390x900 ( "ALCR"      , RRE  , ASMFMT_RRE      , add_logical_carry_register                          ),
 /*B999*/ GENx___x390x900 ( "SLBR"      , RRE  , ASMFMT_RRE      , subtract_logical_borrow_register                    ),
 ...
 /*B9B0*/ GENx___x390x900 ( "CU14"      , RRF_c, ASMFMT_RRF_M3   , convert_utf8_to_utf32                               ),
 /*B9B1*/ GENx___x390x900 ( "CU24"      , RRF_c, ASMFMT_RRF_M3   , convert_utf16_to_utf32                              ),
 /*B9B2*/ GENx___x390x900 ( "CU41"      , RRE  , ASMFMT_RRE      , convert_utf32_to_utf8                               ),
 /*B9B3*/ GENx___x390x900 ( "CU42"      , RRE  , ASMFMT_RRE      , convert_utf32_to_utf16                              ),
 ...
 /*B9BD*/ GENx___x390x900 ( "TRTRE"     , RRF_c, ASMFMT_RRF_M3   , translate_and_test_reverse_extended                 ),
 /*B9BE*/ GENx___x390x900 ( "SRSTU"     , RRE  , ASMFMT_RRE      , search_string_unicode                               ),
 /*B9BF*/ GENx___x390x900 ( "TRTE"      , RRF_c, ASMFMT_RRF_M3   , translate_and_test_extended                         ),
...
static INSTR_FUNC gen_opcode_c0_x[16][NUM_INSTR_TAB_PTRS] =
{
 /*C0x0*/ GENx___x390x900 ( "LARL"      , RIL_b, ASMFMT_RIL_A    , load_address_relative_long                          ),
 /*C0x1*/ GENx___x___x900 ( "LGFI"      , RIL_a, ASMFMT_RIL      , load_long_fullword_immediate                        ),
 /*C0x2*/ GENx___x___x___ ,
 /*C0x3*/ GENx___x___x___ ,
 /*C0x4*/ GENx___x390x900 ( "BRCL"      , RIL_c, ASMFMT_RIL_A    , branch_relative_on_condition_long                   ),
 /*C0x5*/ GENx___x390x900 ( "BRASL"     , RIL_b, ASMFMT_RIL_A    , branch_relative_and_save_long                       ),
...
static INSTR_FUNC gen_opcode_c2_x[16][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*C2x1*/ GENx___x390x900 ( "MSFI"      , RIL_a, ASMFMT_RIL      , multiply_single_immediate_fullword                  ),
 ...
 /*C2x5*/ GENx___x390x900 ( "SLFI"      , RIL_a, ASMFMT_RIL      , subtract_logical_fullword_immediate                 ),
 /*C2x6*/ GENx___x___x___ ,
 /*C2x7*/ GENx___x___x___ ,
 /*C2x8*/ GENx___x___x900 ( "AGFI"      , RIL_a, ASMFMT_RIL      , add_long_fullword_immediate                         ),
 /*C2x9*/ GENx___x390x900 ( "AFI"       , RIL_a, ASMFMT_RIL      , add_fullword_immediate                              ),
 /*C2xA*/ GENx___x___x900 ( "ALGFI"     , RIL_a, ASMFMT_RIL      , add_logical_long_fullword_immediate                 ),
 /*C2xB*/ GENx___x390x900 ( "ALFI"      , RIL_a, ASMFMT_RIL      , add_logical_fullword_immediate                      ),
 /*C2xC*/ GENx___x___x900 ( "CGFI"      , RIL_a, ASMFMT_RIL      , compare_long_fullword_immediate                     ),
 /*C2xD*/ GENx___x390x900 ( "CFI"       , RIL_a, ASMFMT_RIL      , compare_fullword_immediate                          ),
 /*C2xE*/ GENx___x___x900 ( "CLGFI"     , RIL_a, ASMFMT_RIL      , compare_logical_long_fullword_immediate             ),
 /*C2xF*/ GENx___x390x900 ( "CLFI"      , RIL_a, ASMFMT_RIL      , compare_logical_fullword_immediate                  )
};
...
static INSTR_FUNC gen_opcode_c4_x[16][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*C4x2*/ GENx___x390x900 ( "LLHRL"     , RIL_b, ASMFMT_RIL_A    , load_logical_halfword_relative_long                 ),
 /*C4x3*/ GENx___x___x___ ,
 /*C4x4*/ GENx___x___x900 ( "LGHRL"     , RIL_b, ASMFMT_RIL_A    , load_halfword_relative_long_long                    ),
 /*C4x5*/ GENx___x390x900 ( "LHRL"      , RIL_b, ASMFMT_RIL_A    , load_halfword_relative_long                         ),
 /*C4x6*/ GENx___x___x900 ( "LLGHRL"    , RIL_b, ASMFMT_RIL_A    , load_logical_halfword_relative_long_long            ),
 /*C4x7*/ GENx___x390x900 ( "STHRL"     , RIL_b, ASMFMT_RIL_A    , store_halfword_relative_long                        ),
 ...
 /*C4xD*/ GENx___x390x900 ( "LRL"       , RIL_b, ASMFMT_RIL_A    , load_relative_long                                  ),
 /*C4xE*/ GENx___x___x900 ( "LLGFRL"    , RIL_b, ASMFMT_RIL_A    , load_logical_relative_long_long_fullword            ),
 /*C4xF*/ GENx___x390x900 ( "STRL"      , RIL_b, ASMFMT_RIL_A    , store_relative_long                                 )
};
...
static INSTR_FUNC gen_opcode_c6_x[16][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*C6x2*/ GENx___x390x900 ( "PFDRL"     , RIL_c, ASMFMT_RIL_A    , prefetch_data_relative_long                         ),
 /*C6x3*/ GENx___x___x___ ,
 /*C6x4*/ GENx___x___x900 ( "CGHRL"     , RIL_b, ASMFMT_RIL_A    , compare_halfword_relative_long_long                 ),
 /*C6x5*/ GENx___x390x900 ( "CHRL"      , RIL_b, ASMFMT_RIL_A    , compare_halfword_relative_long                      ),
 /*C6x6*/ GENx___x___x900 ( "CLGHRL"    , RIL_b, ASMFMT_RIL_A    , compare_logical_relative_long_long_halfword         ),
 /*C6x7*/ GENx___x390x900 ( "CLHRL"     , RIL_b, ASMFMT_RIL_A    , compare_logical_relative_long_halfword              ),
 ...
 /*C6xD*/ GENx___x390x900 ( "CRL"       , RIL_b, ASMFMT_RIL_A    , compare_relative_long                               ),
 /*C6xE*/ GENx___x___x900 ( "CLGFRL"    , RIL_b, ASMFMT_RIL_A    , compare_logical_relative_long_long_fullword         ),
 /*C6xF*/ GENx___x390x900 ( "CLRL"      , RIL_b, ASMFMT_RIL_A    , compare_logical_relative_long                       )
};
...
static INSTR_FUNC gen_opcode_e3xx[256][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*E312*/ GENx___x390x900 ( "LT"        , RXY_a, ASMFMT_RXY      , load_and_test                                       ),
 ...
 /*E336*/ GENx___x390x900 ( "PFD"       , RXY_b, ASMFMT_RXY      , prefetch_data                                       ),
 ...
 /*E394*/ GENx___x390x900 ( "LLC"       , RXY_a, ASMFMT_RXY      , load_logical_character                              ),
 /*E395*/ GENx___x390x900 ( "LLH"       , RXY_a, ASMFMT_RXY      , load_logical_halfword                               ),
 /*E396*/ GENx___x390x900 ( "ML"        , RXY_a, ASMFMT_RXY      , multiply_logical                                    ),
 /*E397*/ GENx___x390x900 ( "DL"        , RXY_a, ASMFMT_RXY      , divide_logical                                      ),
 /*E398*/ GENx___x390x900 ( "ALC"       , RXY_a, ASMFMT_RXY      , add_logical_carry                                   ),
 /*E399*/ GENx___x390x900 ( "SLB"       , RXY_a, ASMFMT_RXY      , subtract_logical_borrow                             ),
...
/*-------------------------------------------------------------------*/
 ...
 /*E544*/ GENx___x390x900 ( "MVHHI"     , SIL  , ASMFMT_SIL      , move_halfword_from_halfword_immediate               ),
 /*E545*/ GENx___x___x___ ,
 /*E546*/ GENx___x___x___ ,
 /*E547*/ GENx___x___x___ ,
 /*E548*/ GENx___x390x900 ( "MVGHI"     , SIL  , ASMFMT_SIL      , move_long_from_halfword_immediate                   ),
 /*E549*/ GENx___x___x___ ,
 /*E54A*/ GENx___x___x___ ,
 /*E54B*/ GENx___x___x___ ,
 /*E54C*/ GENx___x390x900 ( "MVHI"      , SIL  , ASMFMT_SIL      , move_fullword_from_halfword_immediate               ),
 ...
 /*E554*/ GENx___x390x900 ( "CHHSI"     , SIL  , ASMFMT_SIL      , compare_halfword_immediate_halfword_storage         ),
 /*E555*/ GENx___x390x900 ( "CLHHSI"    , SIL  , ASMFMT_SIL      , compare_logical_immediate_halfword_storage          ),
 /*E556*/ GENx___x___x___ ,
 /*E557*/ GENx___x___x___ ,
 /*E558*/ GENx___x390x900 ( "CGHSI"     , SIL  , ASMFMT_SIL      , compare_halfword_immediate_long_storage             ),
 /*E559*/ GENx___x390x900 ( "CLGHSI"    , SIL  , ASMFMT_SIL      , compare_logical_immediate_long_storage              ),
 /*E55A*/ GENx___x___x___ ,
 /*E55B*/ GENx___x___x___ ,
 /*E55C*/ GENx___x390x900 ( "CHSI"      , SIL  , ASMFMT_SIL      , compare_halfword_immediate_storage                  ),
 /*E55D*/ GENx___x390x900 ( "CLFHSI"    , SIL  , ASMFMT_SIL      , compare_logical_immediate_fullword_storage          ),
...
static INSTR_FUNC gen_opcode_ebxx[256][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*EB1D*/ GENx___x390x900 ( "RLL"       , RSY_a, ASMFMT_RSY      , rotate_left_single_logical                          ),
 ...
 /*EB6A*/ GENx___x390x900 ( "ASI"       , SIY  , ASMFMT_SIY      , add_immediate_storage                               ),
 /*EB6B*/ GENx___x___x___ ,
 /*EB6C*/ GENx___x___x___ ,
 /*EB6D*/ GENx___x___x___ ,
 /*EB6E*/ GENx___x390x900 ( "ALSI"      , SIY  , ASMFMT_SIY      , add_logical_with_signed_immediate                   ),
 ...
 /*EB7A*/ GENx___x390x900 ( "AGSI"      , SIY  , ASMFMT_SIY      , add_immediate_long_storage                          ),
 /*EB7B*/ GENx___x___x___ ,
 /*EB7C*/ GENx___x___x___ ,
 /*EB7D*/ GENx___x___x___ ,
 /*EB7E*/ GENx___x390x900 ( "ALGSI"     , SIY  , ASMFMT_SIY      , add_logical_with_signed_immediate_long              ),
 ...
 /*EB8E*/ GENx___x390x900 ( "MVCLU"     , RSY_a, ASMFMT_RSY      , move_long_unicode                                   ),
 /*EB8F*/ GENx___x390x900 ( "CLCLU"     , RSY_a, ASMFMT_RSY      , compare_logical_long_unicode                        ),
 ...
 /*EBC0*/ GENx___x390x900 ( "TP"        , RSL_a, ASMFMT_RSL      , test_decimal                                        ),
...
static INSTR_FUNC gen_opcode_ecxx[256][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*EC72*/ GENx___x390x900 ( "CIT"       , RIE_a, ASMFMT_RIE_RIM  , compare_immediate_and_trap                          ),
 /*EC73*/ GENx___x390x900 ( "CLFIT"     , RIE_a, ASMFMT_RIE_RIM  , compare_logical_immediate_and_trap_fullword         ),
 /*EC74*/ GENx___x___x___ ,
 /*EC75*/ GENx___x___x___ ,
 /*EC76*/ GENx___x390x900 ( "CRJ"       , RIE_b, ASMFMT_RIE_RRIM , compare_and_branch_relative_register                ),
 /*EC77*/ GENx___x390x900 ( "CLRJ"      , RIE_b, ASMFMT_RIE_RRIM , compare_logical_and_branch_relative_register        ),
 ...
 /*EC7E*/ GENx___x390x900 ( "CIJ"       , RIE_c, ASMFMT_RIE_RMII , compare_immediate_and_branch_relative               ),
 /*EC7F*/ GENx___x390x900 ( "CLIJ"      , RIE_c, ASMFMT_RIE_RMII , compare_logical_immediate_and_branch_relative       ),
 ...
 /*ECF6*/ GENx___x390x900 ( "CRB"       , RRS  , ASMFMT_RRS      , compare_and_branch_register                         ),
 /*ECF7*/ GENx___x390x900 ( "CLRB"      , RRS  , ASMFMT_RRS      , compare_logical_and_branch_register                 ),
 ...
 /*ECFE*/ GENx___x390x900 ( "CIB"       , RIS  , ASMFMT_RIS      , compare_immediate_and_branch                        ),
 /*ECFF*/ GENx___x390x900 ( "CLIB"      , RIS  , ASMFMT_RIS      , compare_logical_immediate_and_branch                )
};
...
static INSTR_FUNC gen_opcode_edxx[256][NUM_INSTR_TAB_PTRS] =
{
 ...
 /*ED2E*/ GENx___x390x900 ( "MAE"       , RXF  , ASMFMT_RXF      , multiply_add_float_short                            ),
 /*ED2F*/ GENx___x390x900 ( "MSE"       , RXF  , ASMFMT_RXF      , multiply_subtract_float_short                       ),
 ...
 /*ED38*/ GENx___x___x900 ( "MAYL"      , RXF  , ASMFMT_RXF      , multiply_add_unnormal_float_long_to_ext_low         ),
 /*ED39*/ GENx___x___x900 ( "MYL"       , RXF  , ASMFMT_RXF      , multiply_unnormal_float_long_to_ext_low             ),
 /*ED3A*/ GENx___x___x900 ( "MAY"       , RXF  , ASMFMT_RXF      , multiply_add_unnormal_float_long_to_ext             ),
 /*ED3B*/ GENx___x___x900 ( "MY"        , RXF  , ASMFMT_RXF      , multiply_unnormal_float_long_to_ext                 ),
 /*ED3C*/ GENx___x___x900 ( "MAYH"      , RXF  , ASMFMT_RXF      , multiply_add_unnormal_float_long_to_ext_high        ),
 /*ED3D*/ GENx___x___x900 ( "MYH"       , RXF  , ASMFMT_RXF      , multiply_unnormal_float_long_to_ext_high            ),
 /*ED3E*/ GENx___x390x900 ( "MAD"       , RXF  , ASMFMT_RXF      , multiply_add_float_long                             ),
 /*ED3F*/ GENx___x390x900 ( "MSD"       , RXF  , ASMFMT_RXF      , multiply_subtract_float_long                        ),
